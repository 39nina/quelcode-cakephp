...
class ContactsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->boolean('sent_info')
            ->requirePresence('sent_info', 'create')
            ->notEmptyString('sent_info');
        ...
        $validator
            ->boolean('is_shipped')
            ->allowEmptyString('is_shipped');

        $validator
            ->boolean('is_rated_by_bidder')
            ->allowEmptyString('is_rated_by_bidder');

        $validator
            ->boolean('is_rated_by_exhibitor')
            ->allowEmptyString('is_rated_by_exhibitor');
