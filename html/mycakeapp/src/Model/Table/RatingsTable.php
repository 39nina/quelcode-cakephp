 ...
 * @property \App\Model\Table\RateTargetsTable&\Cake\ORM\Association\BelongsTo $RateTargets
 *
...
class RatingsTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules)
    {
        ...
        $rules->add($rules->existsIn(['rate_target_id'], 'Users'));
